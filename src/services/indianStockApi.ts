...
class IndianStockApiService {
    ...
    try {
      ...
      if (result) {
        ...
        const stockData: StockData = {
          ...
          industry: 'Software',
          employees: 0,
          description: `${meta.longName || symbol} is an Indian company listed on ${symbol.includes('.NS') ? 'NSE' : 'BSE'}.`,
          website: '',
          ceo: '',
          founded: '',
          headquarters: 'India',
  ...
  private generateMockIndianStockData(symbol: string): StockData {
    ...
    return {
      ...
      description: `${symbol} is a leading Indian company in the technology sector.`,
